...
public class SimpleSmartLedgerClient {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        User user = new SampleUser("/Users/ascatox/Desktop/resources/creds", "PeerAdmin");
        // "Log in"
        client.setUserContext(user);

        // Instantiate channel
        Channel channel = client.newChannel("mychannel");
        channel.addPeer(client.newPeer("peer", "grpc://" + HOST + ":7051"));
        // It always wants orderer, otherwise even query does not work
        channel.addOrderer(client.newOrderer("orderer", "grpc://" + HOST + ":7050"));
        channel.initialize();
